...
public class MovieDao extends AbstractMFlixDao {
    ...
    public MovieDao(
        ...
        commentsCollection = db.getCollection(COMMENTS_COLLECTION);
    }
    ...
    public Document getMovie(String movieId) {
        ...
        pipeline.add(match);
        Bson look = Aggregates.lookup(COMMENTS_COLLECTION, "movie_id", "_id", "comments");
    ...
    public List<Document> getMoviesByCountry(String... country) {
        ...
        Bson countryFilter = Filters.all("countries", Arrays.asList(country));
        moviesCollection
                .find(countryFilter)
                .projection(fields(
                        include("title"))
